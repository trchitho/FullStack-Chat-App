    ...
    <div className="shrink-0 border-b border-base-300 bg-base-100 px-2 py-2 sm:px-5 sm:py-3">
      <div className="flex min-w-0 items-center justify-between gap-2">
        ...
        <div className="flex shrink-0 items-center gap-0.5 text-primary sm:gap-1">
          <button type="button" className="btn btn-circle btn-ghost btn-sm" title={t(language, "voiceCall")} aria-label={t(language, "voiceCall")} onClick={() => startCall(selectedUser, "voice")}><Phone className="size-5" /></button>
          <button type="button" className="btn btn-circle btn-ghost btn-sm" title={t(language, "videoChat")} aria-label={t(language, "videoChat")} onClick={() => startCall(selectedUser, "video")}><Video className="size-5" /></button>
